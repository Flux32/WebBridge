...
namespace Modules.Road
{
    ...
    public class AudioWebBridge : MonoBehaviour
    {
        ...
        ///
        /// Работает для любого играющего ключа: one-shot, зацикленного звука и
        /// музыки. Музыку игра запускать не вправе (трек выбирает React), а
        /// приглушить играющий — да: запуска здесь нет.
        ///
