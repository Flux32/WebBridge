...
`SetVolume` меняет громкость УЖЕ играющего звука, не перезапуская его:
перезапуск ради громкости дал бы звук поверх самого себя. Работает для любого
играющего ключа — one-shot, зацикленного звука и музыки: запускать музыку игра
не вправе (трек выбирает React), а приглушить играющий трек — да. Громкость
здесь обязательна: команду без суффикса React отбрасывает. Ключ, который сейчас
не играет, — no-op.
